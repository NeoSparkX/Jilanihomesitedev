      ...
      >
        ...
        <div className="flex-1 bg-[#111111] px-8 py-10 sm:px-12 sm:py-14 flex flex-col justify-center min-h-[520px]">
          ...
          <Link to="/" className="flex items-center gap-2.5 mb-10 group w-fit">
            <ImageWithFallback
              src="/src/imports/FB_IMG_1776752325972.jpg"
              alt="Jilani Home"
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-[#3B82F6] hover:text-[#60A5FA] transition-colors">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-sm text-[#6B7280] mt-7">
            ...
            <Link to="/signup" className="text-white font-semibold hover:text-[#3B82F6] transition-colors">
              Sign up
            </Link>
          </p>
        </div>
